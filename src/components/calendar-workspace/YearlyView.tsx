...
export function YearlyView() {
  ...
  return (
    <div className="-mx-4 px-4 md:-mx-0 md:px-0 print:m-0 print:flex print:h-full print:min-h-0 print:flex-1 print:flex-col print:overflow-hidden print:p-0">
      <div className="calendar-h-scroll overflow-x-auto overscroll-x-contain pb-4 [-webkit-overflow-scrolling:touch] print:h-full print:min-h-0 print:flex-1 print:overflow-hidden print:pb-0">
